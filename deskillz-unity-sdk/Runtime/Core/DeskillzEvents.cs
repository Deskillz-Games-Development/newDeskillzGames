...
namespace Deskillz
{
    ...
    public static class DeskillzEvents
    {
        ...
        /// <summary>
        /// Fired when reconnection fails after all attempts.
        /// </summary>
        ...
        /// <summary>
        /// Fired when anti-cheat violation is detected.
        /// </summary>
        ...
        internal static void RaiseTestModeChanged(bool enabled)
        {
            DeskillzLogger.LogEvent("Test Mode Changed", enabled.ToString());
            SafeInvoke(OnTestModeChanged, enabled);
        }
        ...
        {
            DeskillzLogger.LogMatch("Started", match.MatchId, $"Mode: {match.Mode}");
