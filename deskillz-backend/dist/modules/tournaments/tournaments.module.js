...
const tournaments_processor_1 = require("./tournaments.processor");
...
exports.TournamentsModule = TournamentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [tournaments_service_1.TournamentsService, tournaments_processor_1.TournamentProcessor],
