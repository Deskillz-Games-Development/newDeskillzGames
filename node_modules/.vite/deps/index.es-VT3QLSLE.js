...
// node_modules/@wagmi/connectors/node_modules/base-x/src/esm/index.js
...
// node_modules/@wagmi/connectors/node_modules/bs58/src/esm/index.js
...
function Ic(t) {
  ...
  function j4(g2, w4, b6, I4 = U5) {
    ...
    C6 && (w4 = e.hash(w4));
    const { r: Z3, s: st3 } = D3, W5 = B4(w4), J5 = c3(st3), Be5 = s(W5 * J5), zt4 = s(Z3 * J5), vt3 = (_a = a2.BASE.multiplyAndAddUnsafe(z3, Be5, zt4)) == null ? void 0 : _a.toAffine();
      ...
      try {
        const u3 = new Promise(async (b6) => {
          ...
          const I4 = yi(new Promise((D3, j4) => {
            this.rpcPublish({ topic: i3, message: s, ttl: a2, prompt: h5, tag: l4, id: d4, attestation: n2 == null ? void 0 : n2.attestation, tvf: n2 == null ? void 0 : n2.tvf }).then(D3).catch((T3) => {
          ...
          try {
            ...
            this.queue.set(d4, Ge3(Ie3({}, g2), { attempt: 1 })), this.logger.warn(D3, D3 == null ? void 0 : D3.message);
          }
        });
        ...
        try {
          const g2 = await yi(new Promise((_2, u3) => {
            this.relayer.request(n2).catch((b6) => {
              this.logger.warn(b6, b6 == null ? void 0 : b6.message), u3(b6);
            }).then(_2);
  ...
  constructor(n2) {
    super(n2), c2(this, "name", dt3), c2(this, "events", new import_events5.default()), c2(this, "initialized", false), c2(this, "requestQueue", { state: $2.idle, queue: [] }), c2(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c2(this, "requestQueueDelay", import_time4.ONE_SECOND), c2(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedLimit", 200), c2(this, "relayMessageCache", []), c2(this, "pendingSessions", /* @__PURE__ */ new Map()), c2(this, "init", async () => {
      ...
      try {
        ...
        throw this.client.logger.error(`approve() -> proposal.get(${e == null ? void 0 : e.id}) failed`), r2.setError(tr3.proposal_not_found), q4;
      }
      try {
      ...
      try {
        g2.addTrace(er3.publishing_session_settle), await this.sendRequest({ topic: I4, method: "wc_sessionSettle", params: T3, throwOnFailedPublish: true }).catch((q4) => {
          throw g2 == null ? void 0 : g2.setError(tr3.session_settle_publish_failure), q4;
          ...
          throw g2 == null ? void 0 : g2.setError(tr3.session_approve_publish_failure), q4;
      ...
      return !e || t !== Q2.link_mode ? false : ((i3 = (s = this.client.metadata) == null ? void 0 : s.redirect) == null ? void 0 : i3.linkMode) === true && ((o2 = (r2 = this.client.metadata) == null ? void 0 : r2.redirect) == null ? void 0 : o2.universal) !== void 0 && ((l4 = (a2 = this.client.metadata) == null ? void 0 : a2.redirect) == null ? void 0 : l4.universal) !== "" && ((p4 = e == null ? void 0 : e.redirect) == null ? void 0 : p4.universal) !== void 0 && ((h5 = e == null ? void 0 : e.redirect) == null ? void 0 : h5.universal) !== "" && ((u3 = e == null ? void 0 : e.redirect) == null ? void 0 : u3.linkMode) === true && this.client.core.linkModeSupportedApps.includes(e.redirect.universal) && typeof (global == null ? void 0 : global.Linking) < "u";
...
var Ie4 = class {
  ...
  async getCapabilities(t) {
    ...
    const w4 = this.client.session.get(t.topic), v6 = ((r2 = w4 == null ? void 0 : w4.sessionProperties) == null ? void 0 : r2.capabilities) || {};
    if (v6 != null && v6[m2]) return v6 == null ? void 0 : v6[m2];
...
var D2 = async () => {
  const { createAppKit: s } = await import("./core-SY2X6F7H.js");
  return s;
};
...
function G4(s) {
  ...
  const c3 = { chains: t, methods: n2 || f5, events: a2 || C5, rpcMap: v5({}, t.length ? { [I3(t)]: u3[I3(t)] } : {}) }, l4 = a2 == null ? void 0 : a2.filter((d4) => !C5.includes(d4)), r2 = n2 == null ? void 0 : n2.filter((d4) => !f5.includes(d4));
  if (!e && !o2 && !i3 && !(l4 != null && l4.length) && !(r2 != null && r2.length)) return { required: t.length ? c3 : void 0 };
  const m2 = (l4 == null ? void 0 : l4.length) && (r2 == null ? void 0 : r2.length) || !e, h5 = { chains: [...new Set(m2 ? c3.chains.concat(e || []) : e)], methods: [...new Set(c3.methods.concat(i3 != null && i3.length ? i3 : A4))], events: [...new Set(c3.events.concat(o2 != null && o2.length ? o2 : P4))], rpcMap: u3 };
...
var b5 = class _b {
  ...
  async connect(t) {
    ...
    try {
      const a2 = await new Promise(async (u3, c3) => {
        ...
        await this.signer.connect(w3(v5({ namespaces: v5({}, n2 && { [this.namespace]: n2 }) }, i3 && { optionalNamespaces: { [this.namespace]: i3 } }), { pairingTopic: t == null ? void 0 : t.pairingTopic, scopedProperties: m2 })).then((h5) => {
          u3(h5);
        }).catch((h5) => {
          var d4;
  ...
  getRpcConfig(t) {
    ...
    const u3 = i3.length ? (t == null ? void 0 : t.methods) || f5 : [], c3 = i3.length ? (t == null ? void 0 : t.events) || C5 : [], l4 = (t == null ? void 0 : t.optionalMethods) || [], r2 = (t == null ? void 0 : t.optionalEvents) || [], m2 = (t == null ? void 0 : t.rpcMap) || this.buildRpcMap(o2, t.projectId), h5 = (t == null ? void 0 : t.qrModalOptions) || void 0;
    return { chains: i3 == null ? void 0 : i3.map((d4) => this.formatChainId(d4)), optionalChains: a2.map((d4) => this.formatChainId(d4)), methods: u3, events: c3, optionalMethods: l4, optionalEvents: r2, rpcMap: m2, showQrModal: !!(t != null && t.showQrModal), qrModalOptions: h5, projectId: t.projectId, metadata: t.metadata };
  }
  buildRpcMap(t, e) {
    const n2 = {};
    return t.forEach((i3) => {
...
@walletconnect/utils/dist/index.es.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=index.es-VT3QLSLE.js.map
