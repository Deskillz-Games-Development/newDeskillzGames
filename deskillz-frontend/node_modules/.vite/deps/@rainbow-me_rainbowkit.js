...
function createKeyPair(options = {}) {
  const { as = "Hex", size: size3 = "short-key:long-sig" } = options;
  const privateKey = randomPrivateKey({ as });
  const publicKey = getPublicKey2({ privateKey, size: size3 });
  return {
    privateKey,
    publicKey
  };
...
function getPublicKey2(options) {
  const { privateKey, size: size3 = "short-key:long-sig" } = options;
  const group = size3 === "short-key:long-sig" ? bls12_381.G1 : bls12_381.G2;
...
function sign(options) {
  const { payload, privateKey, suite, size: size3 = "short-key:long-sig" } = options;
...
function __spreadArray(to2, from17, pack) {
  if (pack || arguments.length === 2) for (var i = 0, l = from17.length, ar; i < l; i++) {
    if (ar || !(i in from17)) {
      if (!ar) ar = Array.prototype.slice.call(from17, 0, i);
      ar[i] = from17[i];
    }
  }
  return to2.concat(ar || Array.prototype.slice.call(from17));
}
...
var R1_RUN_LENGTH_THRESHOLD = 5;
var R2_BLOCK_PENALTY = 3;
var R3_FINDER_PATTERN_LENGTH = 11;
var R3_FINDER_PENALTY = 40;
var R4_BALANCE_STEP_PERCENT = 5;
var R4_BALANCE_STEP_POINTS = 10;
...
function encode4(ver, ecc, data, type6, encoder = utf8ToBytes3) {
  let encoded = "";
...
function encodeQR(text, output = "raw", opts = {}) {
  ...
  if (ver !== void 0) {
    validateVersion(ver);
    data = encode4(ver, ecc, text, encoding, opts.textEncoder);
  } else {
    for (let i = 1; i <= 40; i++) {
      try {
        data = encode4(i, ecc, text, encoding, opts.textEncoder);
        ver = i;
        break;
      } catch (e) {
        err = e;
...
(function(Cuer2) {
  ...
  function Root(props) {
    const { children, size: size3 = "100%", value, version, errorCorrection, ...rest } = props;
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-44JUQ6EW-PFSB5DTM.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-PYAO5YD6-KYJ5W6V3.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-Y4ZOVFV4-JIDNRGYR.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-HRGOJ6VT-K6YAVFXH.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-IGGVC6RM-ZPWQZRBA.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-XSKAA3MF-3IVPIFX5.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-KUOB4UAL-6GVGYMGF.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-4WRQ63RX-OQGKK7RR.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-I2K7AIEP-MBYOFS4Z.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-6VZW6Q3Z-GCBAD5X2.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-N3XOZ4SV-N4KCBBT4.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-IITAPRET-ZGLVOUR4.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-3ZQCKCQE-TAVW6DFE.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-QUPUGMUF-KTUTZJ5U.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-SSN6SV5E-ATJB7BZS.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-7BUVRNYY-3GLHCKOP.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-HJBN674C-TNQDQULP.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-JW3WLRKE-44PU5CZQ.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-VNNRNXY7-V36IG66N.js")).default;
    default:
      return (await import("./en_US-Y4ZOVFV4-JIDNRGYR.js")).default;
  }
};
