...
var ICONS = {
  add: async () => (await import("./add-LRJS5HFV.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-RCKSUFSY.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-KRBTOPOG.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-ORG5WMTX.js")).appStoreSvg,
  apple: async () => (await import("./apple-YWD3KFC6.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-BK6UCH7J.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-XN2BM2KL.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-DVZUYLL2.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-RBZNDZTA.js")).arrowTopSvg,
  bank: async () => (await import("./bank-HUATHPWI.js")).bankSvg,
  browser: async () => (await import("./browser-4U2KWO5G.js")).browserSvg,
  card: async () => (await import("./card-D7RCASBX.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-M76HAY6T.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-IAMY33Z7.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-XYCP53AD.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-XJCBWT56.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-EVV7XKAU.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-NS3S4NSD.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-2HNEAGS5.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-BPU4YB2G.js")).clockSvg,
  close: async () => (await import("./close-SD6GY4JY.js")).closeSvg,
  compass: async () => (await import("./compass-OO5O2PJU.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-JJAXVPNA.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-5DQ3RQCS.js")).copySvg,
  cursor: async () => (await import("./cursor-BWLIYTMF.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-PD67JTG7.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-H5CNVZER.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-OTPRJRJF.js")).disconnectSvg,
  discord: async () => (await import("./discord-FCDL53JB.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-LEKCG75X.js")).etherscanSvg,
  extension: async () => (await import("./extension-UKJYO3NG.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-J6PO465B.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-CQTGXWTY.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-VG5R4QUN.js")).farcasterSvg,
  filters: async () => (await import("./filters-BWHX64RK.js")).filtersSvg,
  github: async () => (await import("./github-RBBHL5OW.js")).githubSvg,
  google: async () => (await import("./google-SKA6GURZ.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-LDQSE5AT.js")).helpCircleSvg,
  image: async () => (await import("./image-BOC4CVJR.js")).imageSvg,
  id: async () => (await import("./id-5RSMHRCX.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-H6BD25N5.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-VEEOUKZC.js")).lightbulbSvg,
  mail: async () => (await import("./mail-JMETSFXR.js")).mailSvg,
  mobile: async () => (await import("./mobile-3HGUNXE2.js")).mobileSvg,
  more: async () => (await import("./more-6KRXXJ4E.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-OVL6P5UE.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-UMYNJKIS.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-HV2CVSFZ.js")).offSvg,
  playStore: async () => (await import("./play-store-Z5MYQ5LQ.js")).playStoreSvg,
  plus: async () => (await import("./plus-5B55UPXV.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-5UKRFZS2.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-UMYRHWZU.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-XRFQK4EU.js")).refreshSvg,
  search: async () => (await import("./search-BDBVS5PP.js")).searchSvg,
  send: async () => (await import("./send-I26MFEPV.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-SFXZRZ7Q.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-WJVOLK2J.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-T3VGEFE4.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-XGKWGHGY.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-EVWR7EV2.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-OO725ROK.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-U47BHYFM.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-Z6SZ5BAR.js")).twitchSvg,
  twitter: async () => (await import("./x-5GLFF2EB.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-JCKYUQEO.js")).twitterIconSvg,
  verify: async () => (await import("./verify-5VMBYAUX.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-KZ6HMI4D.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-3EUB6HNW.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-BVFW4G3W.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-BVFW4G3W.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-BVFW4G3W.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-ZX4KQEMA.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-3NTOGRFM.js")).warningCircleSvg,
  x: async () => (await import("./x-5GLFF2EB.js")).xSvg,
  info: async () => (await import("./info-YVWPTPM3.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-FMKGNUP6.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-R5DGD24Z.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FK4XTWDX.js.map
