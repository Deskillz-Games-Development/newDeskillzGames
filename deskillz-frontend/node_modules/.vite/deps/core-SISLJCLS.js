...
import {
  ...
  toString,
  y
} from "./chunk-QFLXJYZT.js";
import {
  HashMD
} from "./chunk-FHQWC5AW.js";
import {
  LruMap,
  checksumAddress,
  defineFormatter,
  ...
  numberToHex,
  toHex as toHex2
} from "./chunk-3GWOJ3NR.js";
import {
  rotl,
  wrapConstructor
} from "./chunk-L2AIA43T.js";
import "./chunk-VONWVUKP.js";
import {
  require_events
} from "./chunk-NPY75PGV.js";
import "./chunk-HDTS7HQ4.js";
import "./chunk-LPBPATRN.js";
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-WLDHIENA.js");
  const signature_ = (() => {
...
var os = "did:pkh:";
var de2 = (t) => t == null ? void 0 : t.split(":");
var lr2 = (t) => {
  const e = t && de2(t);
...
function br2(t, e, n2, r2 = {}) {
  return n2 == null ? void 0 : n2.sort((o2, i3) => o2.localeCompare(i3)), { att: { [t]: He2(e, n2, r2) } };
}
function He2(t, e, n2 = {}) {
...
function Ic(t) {
  ...
  function j3(g2, w3, b5, I3 = U4) {
    ...
    C5 && (w3 = e.hash(w3));
    const { r: Z2, s: st2 } = D2, W4 = B3(w3), J4 = c3(st2), Be5 = s(W4 * J4), zt4 = s(Z2 * J4), vt3 = (_a = a2.BASE.multiplyAndAddUnsafe(z2, Be5, zt4)) == null ? void 0 : _a.toAffine();
...
function qc(t, e) {
  const n2 = Se2({ encoded: t, encoding: e == null ? void 0 : e.encoding });
  return oo2({ type: Bt2(n2.type), senderPublicKey: typeof n2.senderPublicKey < "u" ? toString(n2.senderPublicKey, G2) : void 0, receiverPublicKey: e == null ? void 0 : e.receiverPublicKey });
}
function oo2(t) {
...
function ha(t, e) {
  let n2 = null;
  return nt2(t == null ? void 0 : t.publicKey, false) || (n2 = ht2("MISSING_OR_INVALID", `${e} controller public key should be a string`)), n2;
}
function mn2(t) {
  let e = true;
...
function Oo2(t, e) {
  ...
  return Object.values(t).forEach((r2) => {
    if (n2) return;
    const o2 = So2(r2 == null ? void 0 : r2.accounts, `${e} namespace`);
    o2 && (n2 = o2);
  }), n2;
}
function Ao2(t, e) {
  let n2 = null;
  return mn2(t == null ? void 0 : t.methods) ? mn2(t == null ? void 0 : t.events) || (n2 = Nt2("UNSUPPORTED_EVENTS", `${e}, events should be an array of strings or empty array for no events`)) : n2 = Nt2("UNSUPPORTED_METHODS", `${e}, methods should be an array of strings or empty array for no methods`), n2;
}
function wn(t, e) {
  let n2 = null;
  return Object.values(t).forEach((r2) => {
...
function To2() {
  return Tt2() && (navigator == null ? void 0 : navigator.onLine);
}
async function Ro2() {
...
var vi2 = class {
  constructor(e, t, i3) {
    this.core = e, this.logger = t, S2(this, "name", Tt3), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      return Vc({ type: l4, symKey: h5, message: c3, senderPublicKey: d4, encoding: o2 == null ? void 0 : o2.encoding });
      ...
      try {
        const c3 = this.getSymKey(s), h5 = Mc({ symKey: c3, encoded: n2, encoding: o2 == null ? void 0 : o2.encoding });
      ...
      try {
        const u3 = new Promise(async (b5) => {
          ...
          const I3 = yi(new Promise((D2, j3) => {
            this.rpcPublish({ topic: i3, message: s, ttl: a2, prompt: h5, tag: l4, id: d4, attestation: n2 == null ? void 0 : n2.attestation, tvf: n2 == null ? void 0 : n2.tvf }).then(D2).catch((T2) => {
          ...
          try {
            ...
            this.queue.set(d4, Ge3(Ie3({}, g2), { attempt: 1 })), this.logger.warn(D2, D2 == null ? void 0 : D2.message);
          }
        });
...
var Li2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, p2(this, "name", Mt3), p2(this, "version", Kt3), p2(this, "events", new import_events4.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [Ft2]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      this.isInitialized();
      const s = jc(), n2 = await this.core.crypto.setSymKey(s), o2 = Ei(import_time3.FIVE_MINUTES), a2 = { protocol: xt3 }, c3 = { topic: n2, expiry: o2, relay: a2, active: false, methods: i3 == null ? void 0 : i3.methods }, h5 = Wc({ protocol: this.core.protocol, version: this.core.version, topic: n2, symKey: s, relay: a2, expiryTimestamp: o2, methods: i3 == null ? void 0 : i3.methods });
      return this.events.emit(re2.create, c3), this.core.expirer.set(n2, o2), await this.pairings.set(n2, c3), await this.core.relayer.subscribe(n2, { transportType: i3 == null ? void 0 : i3.transportType }), { topic: n2, uri: h5 };
    }), p2(this, "pair", async (i3) => {
      this.isInitialized();
      const s = this.core.eventClient.createEvent({ properties: { topic: i3 == null ? void 0 : i3.uri, trace: [G3.pairing_started] } });
      ...
      if (o2 != null && o2.expiryTimestamp && (0, import_time3.toMiliseconds)(o2 == null ? void 0 : o2.expiryTimestamp) < Date.now()) {
...
var Te2 = class _Te extends h2 {
  constructor(e) {
    ...
    const s = k({ level: typeof (e == null ? void 0 : e.logger) == "string" && e.logger ? e.logger : Et3.logger, name: he3 }), { logger: n2, chunkLoggerController: o2 } = A({ opts: s, maxSizeInBytes: e == null ? void 0 : e.maxLogBlobSizeInBytes, loggerOverride: e == null ? void 0 : e.logger });
    ...
    }), this.logger = E(n2, this.name), this.heartbeat = new i(), this.crypto = new vi2(this, this.logger, e == null ? void 0 : e.keychain), this.history = new ki2(this, this.logger), this.expirer = new ji2(this, this.logger), this.storage = e != null && e.storage ? e.storage : new h(qi2(qi2({}, It3), e == null ? void 0 : e.storageOptions)), this.relayer = new Si2({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Li2(this, this.logger), this.verify = new Ui2(this, this.logger, this.storage), this.echoClient = new Mi2(this.projectId || "", this.logger), this.linkModeSupportedApps = [], this.eventClient = new Bi2(this, this.logger, e == null ? void 0 : e.telemetryEnabled), this.setGlobalCore(this);
  }
  static async init(e) {
    const t = new _Te(e);
    await t.initialize();
...
var Ns2 = class extends V {
  constructor(n2) {
    super(n2), c2(this, "name", dt3), c2(this, "events", new import_events5.default()), c2(this, "initialized", false), c2(this, "requestQueue", { state: $2.idle, queue: [] }), c2(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c2(this, "requestQueueDelay", import_time4.ONE_SECOND), c2(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c2(this, "recentlyDeletedLimit", 200), c2(this, "relayMessageCache", []), c2(this, "pendingSessions", /* @__PURE__ */ new Map()), c2(this, "init", async () => {
      ...
      var t, s, i3;
      const r2 = this.client.core.eventClient.createEvent({ properties: { topic: (t = e == null ? void 0 : e.id) == null ? void 0 : t.toString(), trace: [er3.session_approve_started] } });
      try {
        this.isInitialized(), await this.confirmOnlineStateOrThrow();
      } catch (q3) {
      ...
      try {
        ...
        throw this.client.logger.error(`approve() -> proposal.get(${e == null ? void 0 : e.id}) failed`), r2.setError(tr3.proposal_not_found), q3;
      }
      try {
      ...
      try {
        g2.addTrace(er3.publishing_session_settle), await this.sendRequest({ topic: I3, method: "wc_sessionSettle", params: T2, throwOnFailedPublish: true }).catch((q3) => {
          throw g2 == null ? void 0 : g2.setError(tr3.session_settle_publish_failure), q3;
          ...
          throw g2 == null ? void 0 : g2.setError(tr3.session_approve_publish_failure), q3;
      ...
      if (t) try {
        ...
        i3 == null ? void 0 : i3.setError(tr3.proposal_expired);
      } catch {
      }
      ...
      try {
        ...
        this.client.events.listenerCount("session_proposal") === 0 && (console.warn("No listener for session_proposal event"), l4 == null ? void 0 : l4.setError(Y2.proposal_listener_not_found)), this.isValidConnect(v4({}, s.params));
        ...
        l4 == null ? void 0 : l4.addTrace(G3.emit_session_proposal), this.client.events.emit("session_proposal", { id: a2, params: h5, verifyContext: u3 });
      } catch (l4) {
      ...
      return !e || t !== Q2.link_mode ? false : ((i3 = (s = this.client.metadata) == null ? void 0 : s.redirect) == null ? void 0 : i3.linkMode) === true && ((o2 = (r2 = this.client.metadata) == null ? void 0 : r2.redirect) == null ? void 0 : o2.universal) !== void 0 && ((l4 = (a2 = this.client.metadata) == null ? void 0 : a2.redirect) == null ? void 0 : l4.universal) !== "" && ((p3 = e == null ? void 0 : e.redirect) == null ? void 0 : p3.universal) !== void 0 && ((h5 = e == null ? void 0 : e.redirect) == null ? void 0 : h5.universal) !== "" && ((u3 = e == null ? void 0 : e.redirect) == null ? void 0 : u3.linkMode) === true && this.client.core.linkModeSupportedApps.includes(e.redirect.universal) && typeof (global == null ? void 0 : global.Linking) < "u";
...
var Ee4 = class _Ee extends J {
  constructor(n2) {
    ...
    }), this.name = (n2 == null ? void 0 : n2.name) || me3.name, this.metadata = oi(n2 == null ? void 0 : n2.metadata), this.signConfig = n2 == null ? void 0 : n2.signConfig;
    const e = typeof (n2 == null ? void 0 : n2.logger) < "u" && typeof (n2 == null ? void 0 : n2.logger) != "string" ? n2.logger : (0, import_pino.default)(k({ level: (n2 == null ? void 0 : n2.logger) || me3.logger }));
    this.core = (n2 == null ? void 0 : n2.core) || new Xo2(n2), this.logger = E(e, this.name), this.session = new St4(this.core, this.logger), this.proposal = new Os2(this.core, this.logger), this.pendingRequest = new bs2(this.core, this.logger), this.engine = new Ns2(this), this.auth = new Ls2(this.core, this.logger);
  }
...
var B2 = class _B {
  constructor(t) {
    l3(this, "client"), l3(this, "namespaces"), l3(this, "optionalNamespaces"), l3(this, "sessionProperties"), l3(this, "scopedProperties"), l3(this, "events", new import_events6.default()), l3(this, "rpcProviders", {}), l3(this, "session"), l3(this, "providerOpts"), l3(this, "logger"), l3(this, "uri"), l3(this, "disableProviderPing", false), this.providerOpts = t, this.logger = typeof (t == null ? void 0 : t.logger) < "u" && typeof (t == null ? void 0 : t.logger) != "string" ? t.logger : (0, import_pino.default)(k({ level: (t == null ? void 0 : t.logger) || et2 })), this.disableProviderPing = (t == null ? void 0 : t.disableProviderPing) || false;
  }
  static async init(t) {
    const e = new _B(t);
    return await e.initialize(), e;
...
var UniversalAdapter = class extends AdapterBlueprint {
  ...
  async getBalance(params) {
    ...
    const balance = balances.find((b5) => {
      var _a2, _b2;
      return b5.chainId === `${(_a2 = params.caipNetwork) == null ? void 0 : _a2.chainNamespace}:${params.chainId}` && b5.symbol === ((_b2 = params.caipNetwork) == null ? void 0 : _b2.nativeCurrency.symbol);
    });
    return {
      balance: (balance == null ? void 0 : balance.quantity.numeric) || "0.00",
      symbol: (balance == null ? void 0 : balance.symbol) || ((_e6 = params.caipNetwork) == null ? void 0 : _e6.nativeCurrency.symbol) || ""
    };
  }
              ...
              params: [
                {
                  ...
                  blockExplorerUrls: [(_e6 = caipNetwork.blockExplorers) == null ? void 0 : _e6.default.url]
                }
              ]
            }));
          } catch (error) {
...
var AppKitBaseClient = class {
    ...
    this.connectionControllerClient = {
      ...
      connectExternal: async ({ id, info, type, provider, chain, caipNetwork, socialUri }) => {
        ...
        const res = await adapter.connect({
          ...
          rpcUrl: ((_c2 = (_b = (_a = caipNetwork == null ? void 0 : caipNetwork.rpcUrls) == null ? void 0 : _a.default) == null ? void 0 : _b.http) == null ? void 0 : _c2[0]) || ((_f = (_e6 = (_d = fallbackCaipNetwork == null ? void 0 : fallbackCaipNetwork.rpcUrls) == null ? void 0 : _d.default) == null ? void 0 : _e6.http) == null ? void 0 : _f[0])
        });
        if (!res) {
          return;
        }
  ...
  getApprovedCaipNetworksData() {
    ...
    if (providerType === ConstantsUtil3.CONNECTOR_TYPE_WALLET_CONNECT) {
      ...
      return {
         ...
         */
        supportsAllNetworks: ((_e6 = (_d = (_c2 = this.universalProvider) == null ? void 0 : _c2.session) == null ? void 0 : _d.peer) == null ? void 0 : _e6.metadata.name) === "MetaMask Wallet",
  ...
  createAdapters(blueprints) {
    ...
    return this.chainNamespaces.reduce((adapters, namespace) => {
      var _a;
      const blueprint = blueprints == null ? void 0 : blueprints.find((b5) => b5.namespace === namespace);
      if (blueprint) {
        blueprint.construct({
          namespace,
  ...
  async syncWalletConnectAccount() {
    const syncTasks = this.chainNamespaces.map(async (chainNamespace) => {
      ...
      const activeChainId = (_e6 = ChainController.state.activeCaipNetwork) == null ? void 0 : _e6.id;
  ...
  syncWalletConnectAccounts(chainNamespace) {
    var _a, _b, _c2, _d, _e6;
    const addresses = (_e6 = (_d = (_c2 = (_b = (_a = this.universalProvider) == null ? void 0 : _a.session) == null ? void 0 : _b.namespaces) == null ? void 0 : _c2[chainNamespace]) == null ? void 0 : _d.accounts) == null ? void 0 : _e6.map((account) => {
  ...
  async initializeUniversalAdapter() {
    var _a, _b, _c2, _d, _e6, _f, _g, _h, _i3, _j;
    ...
    const universalProviderOptions = {
      ...
      metadata: {
        ...
        description: ((_d = this.options) == null ? void 0 : _d.metadata) ? (_e6 = this.options) == null ? void 0 : _e6.metadata.description : "",
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-LB37PRPT.js");
      await import("./w3m-modal-T3XP2ZCD.js");
...
@walletconnect/utils/dist/index.es.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=core-SISLJCLS.js.map
